...
# line 2 in printf ${color_gray}${network^} Fullnode${LNinfo} ${torInfo}
printf "
${color_amber}%s ${color_green} ${ln_alias} ${upsInfo}
${color_gray}%s
${color_gray}%s 
Temperatur %s°C %s°F
${color_gray}Free Mem ${color_ram}${ram} ${color_gray}
HDDuse ${color_hdd}%s${color_gray}
${color_gray}SSH admin@${internet_localip}${color_gray} d${internet_rx} u${internet_tx}
${color_gray}${webuiinfo} 
${color_gray}${network} ${color_green}${networkVersion}${color_gray}${chain}net ${networkConnectionsInfo}
${color_gray}${blockInfo} %s
${color_gray}${LNline}
${color_gray}${ln_channelInfo} ${ln_peersInfo}
${color_gray}${ln_feeReport}
" \
